...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        c7 = new JCheckBox("I hereby declares that the above enterd details are correct to best of my knowledge");
        ...
        // Add ActionListener to c7 (declaration checkbox)
        c7.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                submit.setEnabled(c7.isSelected()); // Enable only if c7 is checked
            }
        });
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == submit) {
            ...
            if (r1.isSelected()) {
                ...
                accountType = "Reccuring Deposiit Account";
            }
            ...
            if (c4.isSelected()) {
                facility = facility + " Email & Mobile Alerts,";
            }
            if (c5.isSelected()) {
