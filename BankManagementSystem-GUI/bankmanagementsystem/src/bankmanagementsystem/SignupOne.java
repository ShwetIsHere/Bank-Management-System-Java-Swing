...
import com.toedter.calendar.JDateChooser; //add calender for date of birth
...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        // this block is generating random form number
        ...
        JLabel personDetailes = new JLabel("Page 1: Personal Details");
        personDetailes.setFont(new Font("Raleway", Font.BOLD, 22));
        personDetailes.setBounds(290, 80, 400, 30);
        add(personDetailes);
        ...
        // date of birth and insert calender
        ...
        ButtonGroup gendergroup = new ButtonGroup(); // for both selected at same time
        ...
        ButtonGroup maritalGroup = new ButtonGroup(); // for both selected at same time
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Handle JDateChooser null value properly
        String dob = "";
